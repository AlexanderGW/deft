...
class FormField {
	...
	public function isAutoComplete( $value = null ) {
		...
		$this->setAttribute( 'autocomplete', ( (bool)$value ? 'on' : 'off' ) );
		return $this;
	}
	...
	public function isDisabled( $value = null ) {
		...
		$this->setAttribute( 'disabled', (bool)$value );
		return $this;
	}
	...
	public function isReadOnly( $value = null ) {
		...
		$this->setAttribute( 'readonly', (bool)$value );
		return $this;
	}
	...
	public function isRequired( $value = null ) {
		...
		$this->setAttribute( 'required', (bool)$value );
		return $this;
	}
	...
	public function cols( $value = null ) {
		...
		$this->setAttribute( 'cols', (int)$value );
		return $this;
	}
	...
	public function maxLength( $value = null ) {
		...
		$this->setAttribute( 'maxlength', (int)$value );
		return $this;
	}
	...
	public function rows( $value = null ) {
		...
		$this->setAttribute( 'rows', (int)$value );
		return $this;
	}
	...
	public function size( $value = null ) {
		...
		$this->setAttribute( 'size', (int)$value );
		return $this;
	}
	...
	public function step( $value = null ) {
		...
		$this->setAttribute( 'step', (float)$value );
		return $this;
	}
			...
			case self::Radio :
				...
				if( count( $this->field_options ) ) {
					...
					foreach( $this->field_options as $value => $label ) {
						...
						$element = Html::element( 'input', $option_attributes, 'elementInput' );
						$template = Filter::exec( 'formFieldRadioOptionTemplate', '<label>%1$s<span>%2$s</span></label>' );
						if( !empty( $template ) )
							$elements .= sprintf( $template, $element, $label );
						else
							$elements .= $element;
