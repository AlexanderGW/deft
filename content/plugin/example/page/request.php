...
$form = Snappy::getForm();
$form->add( FormField::Textarea )->label( 'Response' )->value( $result )->rows( 20 );

?>
<h3><?php ___( 'Snappy &ndash; The cURL request helper' ) ?></h3>
<p><a href="./">Return to previous page.</a><br>A brief example of the URI based request helper and the information provided using the <code>Http::request()</code> function.</p>
<?php echo $form;